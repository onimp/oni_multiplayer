...
public class SteamServer : IMultiplayerServer {
    ...
    public event Action<PlayerEventArgs>? PlayerConnected;
    public event Action<PlayerEventArgs>? PlayerDisconnected;
        ...
        switch (state) {
            case k_ESteamNetworkingConnectionState_Connecting:
                if (TryAcceptConnection(connection, clientSteamId))
                    PlayerConnected?.Invoke(new PlayerEventArgs(new SteamPlayer(clientSteamId)));
                break;
    ...
    private void CloseConnection(HSteamNetConnection connection, CSteamID clientSteamId) {
        PlayerDisconnected?.Invoke(new PlayerEventArgs(new SteamPlayer(clientSteamId)));
        SteamGameServerNetworkingSockets.CloseConnection(
            connection,
