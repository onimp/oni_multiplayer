...
namespace MultiplayerMod
{
    ...
    {
        public static object InvokePrivate<T>(this T instance, string methodName, params object[] args)
        {
        ...
        public static object InvokePrivate<T>(this T instance, string methodName, Type[] genericTypes,
            params object[] args)
        {
            var method = typeof(T).GetMethod(methodName,
                BindingFlags.NonPublic | BindingFlags.Instance);
        ...
        public static T GetPrivateField<T>(this object instance, string fieldName)
        {
            ...
            return (T)type.GetField(fieldName,
        ...
        {
            return (T2)typeof(T).GetField(fieldName,
                BindingFlags.NonPublic | BindingFlags.Instance)!.GetValue(instance);
        }
        ...
        {
            var type = instance.GetType();
            return (T)type.GetProperty(fieldName,
                BindingFlags.Public | BindingFlags.Instance)!.GetValue(instance);
        }

        public static Type GetNestedType(this Type parentType, string subTypeName)
        {
            return parentType.GetNestedType(subTypeName,
                BindingFlags.NonPublic | BindingFlags.Instance);
        }
