...
public static class Dependencies {
    ...
    public static void Register<T>(DependencyOptions options = DependencyOptions.Default) where T : class =>
        container.Register<T>(options);

    public static void Register<I, T>(DependencyOptions options = DependencyOptions.Default) where T : class, I =>
        container.Register<I, T>(options);
