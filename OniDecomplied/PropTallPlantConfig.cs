...
public class PropTallPlantConfig : IEntityConfig
{
  ...
  public GameObject CreatePrefab()
  {
    ...
    KAnimFile anim = Assets.GetAnim(HashedString.op_Implicit("gravitas_tall_plant_kanim"));
    EffectorValues decor = tieR0_1;
    EffectorValues noise = tieR0_2;
    List<Tag> additionalTags = new List<Tag>();
    additionalTags.Add(GameTags.Gravitas);
    GameObject placedEntity = EntityTemplates.CreatePlacedEntity("PropTallPlant", name, desc, 50f, anim, "off", Grid.SceneLayer.Building, 1, 3, decor, noise, additionalTags: additionalTags);
