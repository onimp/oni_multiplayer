...
public class GasCargoBayClusterConfig : IBuildingConfig
{
  ...
  public override BuildingDef CreateBuildingDef()
  {
    ...
    BuildingDef buildingDef = BuildingTemplates.CreateBuildingDef("GasCargoBayCluster", 5, 5, "rocket_cluster_storage_gas_kanim", 1000, 60f, cargoMass, construction_materials, 9999f, BuildLocationRule.Anywhere, none, noise);
