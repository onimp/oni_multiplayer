...
public class SolidCargoBayConfig : IBuildingConfig
{
  ...
  public override BuildingDef CreateBuildingDef()
  {
    ...
    BuildingDef buildingDef = BuildingTemplates.CreateBuildingDef("CargoBay", 5, 5, "rocket_storage_solid_kanim", 1000, 60f, cargoMass, construction_materials, 9999f, BuildLocationRule.BuildingAttachPoint, none, noise);
