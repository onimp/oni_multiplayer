...
public class LimitOneEngine : SelectModuleCondition
{
    ...
    SelectModuleCondition.SelectionContext selectionContext)
  {
    ...
    {
      if ((selectionContext != SelectModuleCondition.SelectionContext.ReplaceModule || !Object.op_Equality((Object) gameObject, (Object) existingModule.gameObject)) && (Object.op_Inequality((Object) gameObject.GetComponent<RocketEngineCluster>(), (Object) null) || Object.op_Inequality((Object) gameObject.GetComponent<BuildingUnderConstruction>(), (Object) null) && Object.op_Inequality((Object) gameObject.GetComponent<BuildingUnderConstruction>().Def.BuildingComplete.GetComponent<RocketEngineCluster>(), (Object) null)))
        return false;
    }
    return true;
  }
