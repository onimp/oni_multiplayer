...
public class FullereneCometConfig : IEntityConfig
{
  ...
  {
    GameObject entity = EntityTemplates.CreateEntity(FullereneCometConfig.ID, (string) UI.SPACEDESTINATIONS.COMETS.FULLERENECOMET.NAME);
    ...
    {
      Assets.GetAnim(HashedString.op_Implicit("meteor_fullerene_kanim"))
    };
